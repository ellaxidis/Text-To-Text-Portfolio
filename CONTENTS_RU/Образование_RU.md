...
##### **Событие 3: Запуск спутника СPUTNIK (1957)**  
...
- **Тестирование:** Краткий квиз с вопросами:  
  ...
  - "Почему запуск СPUTNIK стал переломным моментом в истории?"  
...
- **Видеоролики:** История парового двигателя (YouTube), лекция Фарадея о магнетизме.
