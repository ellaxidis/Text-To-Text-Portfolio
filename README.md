...
Good day, and welcome to my portfolio! 🙌 Here you'll find my best AI Works created using up-to-date information from the internet. For content creation, I used the following neural nets — DeepSeek, Qwen, GigaChat. Each work is presented in a separate file in the "Contents" section. The files are available in Markdown format. Enjoy browsing! 😊
